...
public class RedisConstants {
    public static final String DEAL_CACHE_STAVE_BY_LOCK = "deal_cache_stave_by_lock";
    public static final String DEAL_CACHE_STAVE_BY_LOGIC = "deal_cache_stave_by_logic";
    ...
    public static final Long CACHE_SHOP_TTL_SECONDS = 1800L;
